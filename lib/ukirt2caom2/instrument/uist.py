...
uist_imaging_filters = {
        ...
        '1.58CH4_s': (1.550, 1.657, '1.58(CH4_s)',    1.604),
        '1.644Fe':   (1.630, 1.656, '1.644(FeII)[MK]',1.643),
        '1.69CH4_l': (1.617, 1.730, '1.69(CH4_l)',    1.674),
        '2.122MK':   (2.103, 2.134, '2.122[MK]',      None), #2.127),
        ...
        '3.05ice':   (2.970, 3.125, '3.05(ice)[MK]',  3.048),
        ...
        'BrG':       (2.150, 2.182, 'BrG[MK]',        2.168),# Same as UFTI 2.166(BrG)[MK] ?
