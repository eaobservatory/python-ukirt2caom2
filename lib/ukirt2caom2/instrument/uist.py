...
uist_imaging_filters = {
        '1.57':      (1.561, 1.583, '1.57(cont)[MK]', None), #1.573),
        '1.58CH4_s': (1.550, 1.657, '1.58(CH4_s)',    1.58),
        '1.644Fe':   (1.630, 1.656, '1.644(FeII)[MK]',1.644),
        '1.69CH4_l': (1.617, 1.730, '1.69(CH4_l)',    1.69),
        '2.122MK':   (2.103, 2.134, '2.122[MK]',      2.1218),
        '2.122S(1)': (2.106, 2.124, '2.122(S1)',      2.1218),
        '2.248MK':   (2.235, 2.270, '2.248[MK]',      None), #2.263),
        '2.248S(1)': (2.234, 2.269, '2.248(S1)',      2.2477),
        '2.27':      (2.257, 2.291, '2.27(cont)[MK]', None), #2.274),
        '2.42CO':    (2.413, 2.436, '2.42(CO)',       2.425),
        '3.05ice':   (2.970, 3.125, '3.05(ice)[MK]',  3.05),
        '3.30PAH':   (3.264, 3.318, '3.29(PAH)[MK]',  3.29),
        '3.4nbL':    (3.379, 3.451, '3.4nbL',         None), #3.415),
        '3.5mbL':    (3.383, 3.594, '3.5mbL',         None), #3.489),
        '3.6nbLp':   (3.560, 3.625, "3.6nbL'",        None), #3.593),
        '3.99':      (3.964, 4.016, '3.99(cont)',     None), #3.990),
        'BrG':       (2.150, 2.182, '2.166(BrG)[MK]', 2.166),
        'Dust':      (3.250, 3.305, '3.28(dust)',     3.28),
        'H98':       (1.490, 1.780, 'H[MK]',          None), #1.64),
        'J98':       (1.170, 1.330, 'J[MK]',          None), #1.25),
        'K98':       (2.030, 2.370, 'K[MK]',          None), #2.20),
        'K_s_MK':    (1.990, 2.310, 'Kshort[MK]',     None), #2.15),
        'Kp':        (2.030, 2.370, "K'",             None), #2.20),
        'Kshort':    (2.028, 2.290, 'Kshort',         None), #2.20),
        'Lp98':      (3.428, 4.108, "L'[MK]",         None), #3.77),
        'Mp98':      (4.572, 4.800, "M'[MK]",         None), #4.69),
        'Y_MK':      (0.966, 1.078, 'Y[MK]',          None), #1.022),
        'ZMK':       (1.008, 1.058, 'Z[MK]',          None), #1.03),
}
...
for (alias, filter) in (
    ...
    uist_imaging_filters[alias] = uist_imaging_filters[filter]
