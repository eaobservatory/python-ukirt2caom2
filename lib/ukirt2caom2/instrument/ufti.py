...
ufti_filters = {
        ...
        '2.122MK':   (2.103, 2.134, '2.122[MK]',       2.122),
        '2.248MK':   (2.235, 2.270, '2.248[MK]',       2.248),
        '2.248S(1)': (None,  None,  '2.248(S1)',       2.248),
        '2.27':      (2.260, 2.280, '2.27(cont)[MK]',  None), #2.27),
        '2.32':      (2.310, 2.331, '2.32(CO-1%)',     2.32),
        '2.424':     (None,  None,  'Qbranch',         2.424), # Not useable 1998-2000
        'BrG':       (2.155, 2.177, '2.166(BrG)[MK]',  2.166),
        'BrGz':      (2.147, 2.199, '2.173(BrGz)',     2.166), # Redshifted BrGamma line
